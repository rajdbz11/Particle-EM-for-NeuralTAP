...
for s = 1:Ns
    [x_truedec(:,:,s), P_truedec(:,:,:,s), WMat(:,s)] ...
        = particlefilter(rMatFull(:,:,s), hMatFull(:,:,s), K, lam, Qpr, Qobs, U, J, G, nltype);
...
for s = 1:Ns
    [x_1(:,:,s), P_1(:,:,:,s), W_1(:,s), temp] ...
        = particlefilter(rMatFull(:,:,s), hMatFull(:,:,s), K, lam, Qpr, Qobs, U_1, J_1, G_1, nltype);
...
for iterem = 1:EMIters
    ...
    [~, P_B, WB] = particlefilter(rB, hB, K, lam, Qpr, Qobs, U_1, J_1, G_1, nltype);   
end
